...
*/
	...
	kmSetVertex(&vertexBufferDesc, &vertices_G4[1], KM_VERTEXTYPE_00, sizeof(KMVERTEX_03));
	kmSetVertex(&vertexBufferDesc, &vertices_G4[2], KM_VERTEXTYPE_00, sizeof(KMVERTEX_03));	
	kmSetVertex(&vertexBufferDesc, &vertices_G4[3], KM_VERTEXTYPE_00, sizeof(KMVERTEX_03));	
