...
typedef struct {
	unsigned long	id;	
	unsigned char	r0, g0, b0, p0;		/* Color of vertex 0 */
	unsigned char	r1, g1, b1, p1;		/* Color of vertex 1 */
	unsigned char	r2, g2, b2, p2;		/* Color of vertex 2 */
	unsigned char	r3, g3, b3, p3;		/* Color of vertex 3 */
	unsigned short	tpage, clut;		/* texture page ID, clut ID */
	unsigned char	u0, v0, u1, v1;		/* texture corner point */
	...
	unsigned short	vert0, vert1; 		/* index of vertex */
	unsigned short	vert2, vert3;		
	unsigned short	norm0, norm1; 		/* index of normal */
 ...
 */
typedef struct {
	unsigned long  mode;		/* pixel mode */
	RECT	*crect;		/* CLUT rectangle on frame buffer */
	unsigned long	*caddr;		/* CLUT address on main memory */
	RECT	*prect;		/* texture image rectangle on frame buffer */
	unsigned long	*paddr;		/* texture image address on main memory */
} TIM_IMAGE;
...
extern int CheckPrim(char *s, unsigned long *p);
