...
//english			//french			//german		//italian		//american
	...
	"Up",			"Touche souris haut","Nach-oben-Taste","Freccia su","Up",                 
	"Page Up",		"Pg. préc.",       	"Bild-auf",     "Pgsu",		    "Page Up",            
	"",				"",               	"",             "",             "",                   
	"Left",			"Touche souris gauche","Nach-links-Taste","Freccia sinistra","Left",               
	"",				"",               	"",             "",             "",                   
	"Right",		"Touche souris droite","Nach-rechts-Taste","Freccia destra","Right",              
	"",				"",               	"",             "",             "",                   
	"End",			"Fin",            	"Ende",         "Fine",         "End",                
	"Down",			"Touche souris bas","Nach-unten-Taste","Freccia giù","Down",               
	...
	"",				"",               	"",             "",             "",                   
	"",				"",               	"",             "",             "",                   
	"Left Win",		"Symbole Windows gauche","Windowstaste links","Tasto Win sinistro","Left Win",           
	"Right Win",	"Symbole Windows droit","Windowstaste rechts","Tasto Win destro","Right Win",          
	"Apps",			"Touche d'application","Anwendungstaste","Tasto Menu di scelta rapida","Apps",               
};
