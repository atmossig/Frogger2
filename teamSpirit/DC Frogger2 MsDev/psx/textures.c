...
void LoadTextureAnimBank ( int textureBank )
{
	...
	// *ASL* 21/07/2000 - Re-cast from (TEXTUREANIM *) to expected (unsigned long *)
...
//	// *ASL* 22/07/2000 - Need to remove as causing crash!
//	// *ASL* 21/07/2000 - Parameters already pointers
