...
#define FROGSTATUS_LONGHOPFLAGS (FROGSTATUS_ISWANTINGLONGHOPU | FROGSTATUS_ISWANTINGLONGHOPD | FROGSTATUS_ISWANTINGLONGHOPL | FROGSTATUS_ISWANTINGLONGHOPR)
#define FROGSTATUS_ALLHOPFLAGS (FROGSTATUS_HOPFLAGS|FROGSTATUS_SUPERHOPFLAGS|FROGSTATUS_LONGHOPFLAGS)
