...
//------------------------------------------------ SUBTERRANEAN
	...
	4,						// number of levels
		{ 
		"gold mine","sub1.bmp",80,		LEVELID_SUBTERRANEAN1,LEVELID_SUBTERRANEAN2,WORLDID_SUBTERRANEAN,SUBTERRANEANLEV1_OBJ_BANK,0,SUBTERRANEANLEV1_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"ants nest","sub2.bmp",80,		LEVELID_SUBTERRANEAN2,LEVELID_SUBTERRANEAN3,WORLDID_SUBTERRANEAN,SUBTERRANEANLEV2_OBJ_BANK,0,SUBTERRANEANLEV2_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"lava hell","sub3.bmp",90,	LEVELID_SUBTERRANEAN4,LEVELID_SPACE1,WORLDID_SPACE,SUBTERRANEANBOSS_OBJ_BANK,0,SUBTERRANEANMASTER_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
...
//------------------------------------------------ LABORATORY
	...
	4,						// number of levels
		{ 
		"the steam room","lab1.bmp",80,		LEVELID_LABORATORY1,LEVELID_LABORATORY2,WORLDID_LABORATORY,LABORATORYLEV1_OBJ_BANK,0,LABORATORYLEV1_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"research facility","lab2.bmp",80,		LEVELID_LABORATORY3,LEVELID_LABORATORY3,WORLDID_LABORATORY,LABORATORYLEV3_OBJ_BANK,0,LABORATORYLEV3_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"infernal machine","lab3.bmp",65,LEVELID_LABORATORY4,LEVELID_HALLOWEEN1,WORLDID_HALLOWEEN,LABORATORYBOSSA_OBJ_BANK,0,LABORATORYMASTERA_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
...
//------------------------------------------------ HALLOWEEN
	...
	4,						// number of levels 
		{ 
		"graveyard garden","hall1.bmp",90,		LEVELID_HALLOWEEN1,LEVELID_HALLOWEEN2,WORLDID_HALLOWEEN,	HALLOWEENLEV1_OBJ_BANK,0,HALLOWEENLEV1_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"haunted house","hall2.bmp",90,		LEVELID_HALLOWEEN2,LEVELID_HALLOWEEN3,WORLDID_HALLOWEEN,	HALLOWEENLEV2_OBJ_BANK,0,HALLOWEENLEV2_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"tower o traps","hall3.bmp",0,		LEVELID_HALLOWEEN4,LEVELID_SUPERRETRO1,WORLDID_SUPERRETRO,	HALLOWEENBOSS_OBJ_BANK,0,HALLOWEENMASTER_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
...
//------------------------------------------------ SUPERRETRO
	...
	10,						// number of levels
		{ 
		"super 1 50","super1.bmp",50,		LEVELID_SUPERRETRO1,LEVELID_SUPERRETRO2,WORLDID_SUPERRETRO,RETROLEV1_OBJ_BANK,0,RETROLEV1_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 2 50","super1.bmp",50,		LEVELID_SUPERRETRO2,LEVELID_SUPERRETRO3,WORLDID_SUPERRETRO,RETROLEV2_OBJ_BANK,0,RETROLEV2_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 3 50","super1.bmp",50,		LEVELID_SUPERRETRO3,LEVELID_SUPERRETRO4,WORLDID_SUPERRETRO,RETROLEV3_OBJ_BANK,0,RETROLEV3_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 4 50","super1.bmp",50,		LEVELID_SUPERRETRO4,LEVELID_SUPERRETRO5,WORLDID_SUPERRETRO,RETROLEV4_OBJ_BANK,0,RETROLEV4_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 5 50","super1.bmp",50,		LEVELID_SUPERRETRO5,LEVELID_SUPERRETRO6,WORLDID_SUPERRETRO,RETROLEV5_OBJ_BANK,0,RETROLEV5_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 6 50","super1.bmp",50,		LEVELID_SUPERRETRO6,LEVELID_SUPERRETRO7,WORLDID_SUPERRETRO,RETROLEV6_OBJ_BANK,0,RETROLEV6_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 7 50","super1.bmp",50,		LEVELID_SUPERRETRO7,LEVELID_SUPERRETRO8,WORLDID_SUPERRETRO,RETROLEV7_OBJ_BANK,0,RETROLEV7_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 8 50","super1.bmp",50,		LEVELID_SUPERRETRO8,LEVELID_SUPERRETRO9,WORLDID_SUPERRETRO,RETROLEV8_OBJ_BANK,0,RETROLEV8_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 9 50","super1.bmp",50,		LEVELID_SUPERRETRO9,LEVELID_SUPERRETRO10,WORLDID_SUPERRETRO,RETROLEV9_OBJ_BANK,0,RETROLEV9_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 10 50","super1.bmp",50,		LEVELID_SUPERRETRO10,LEVELID_FRONTEND1,WORLDID_FRONTEND,RETROLEV10_OBJ_BANK,0,RETROLEV10_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		},
	},
