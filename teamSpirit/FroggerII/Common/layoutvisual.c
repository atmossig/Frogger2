...
//------------------------------------------------ GARDEN
	...
	5,						// number of levels
		{ 
		"garden 1  85",	LEVELID_GARDEN1,GARDENLEV1_OBJ_BANK,0,GARDENLEV1_COL,LEVEL_OPEN,WORLDID_ANCIENT,0,  0,0,0,1100,1100,800,
		"garden 2  55",	LEVELID_GARDEN2,GARDENLEV2_OBJ_BANK,0,GARDENLEV2_COL,LEVEL_CLOSED,WORLDID_SPACE,0, 0,0,0,1100,1100,800,
		"garden boss  0",	LEVELID_GARDEN4,GARDENBOSSA_OBJ_BANK,0,GARDENMASTERA_COL,LEVEL_CLOSED,WORLDID_SUBTERRANEAN,0, 0,0, 0,1100,1100,800,
...
//------------------------------------------------ ANCIENT
	...
	5,						// number of levels
		{ 
		"ancient 1 55",	LEVELID_ANCIENT1,ANCIENTLEV1_OBJ_BANK,0,ANCIENTLEV1_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"ancient 3 40",	LEVELID_ANCIENT3,ANCIENTLEV3_OBJ_BANK,0,ANCIENTLEV3_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
...
//------------------------------------------------ SPACE
	...
	5,						// number of levels
		{ 
		"space 1 95",		LEVELID_SPACE1,SPACELEV1_OBJ_BANK,0,SPACELEV1_COL,LEVEL_CLOSED,-1,0, 0,0, 0,500,6500,1100,
		"space 3 84",		LEVELID_SPACE3,SPACELEV3_OBJ_BANK,0,SPACELEV3_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"space boss 84",	LEVELID_SPACE4,SPACEBOSS_OBJ_BANK,0,SPACEMASTER_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
...
//------------------------------------------------ CITY
	...
	5,						// number of levels
		{ 
		"city 1 20",		LEVELID_CITY1,CITYLEV1_OBJ_BANK,0,CITYLEV1_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"city 2 20",		LEVELID_CITY2,CITYLEV2_OBJ_BANK,0,CITYLEV2_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"city 3 75",		LEVELID_CITY3,CITYLEV3_OBJ_BANK,0,CITYLEV3_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"city multi 0",		LEVELID_CITY6,CITYMULTI_OBJ_BANK,0,CITYMULTI_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		},
	},
...
//------------------------------------------------ SUBTERRANEAN
	...
	5,						// number of levels
		{ 
		"sub 1 62",		LEVELID_SUBTERRANEAN1,SUBTERRANEANLEV1_OBJ_BANK,0,SUBTERRANEANLEV1_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"sub 2 80",		LEVELID_SUBTERRANEAN2,SUBTERRANEANLEV2_OBJ_BANK,0,SUBTERRANEANLEV2_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"sub 3 80",		LEVELID_SUBTERRANEAN3,SUBTERRANEANLEV3_OBJ_BANK,0,SUBTERRANEANLEV3_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"sub boss 40",		LEVELID_SUBTERRANEAN4,SUBTERRANEANBOSS_OBJ_BANK,0,SUBTERRANEANMASTER_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
...
//------------------------------------------------ LABORATORY
	...
	5,						// number of levels
		{ 
		"lab 1 85",		LEVELID_LABORATORY1,LABORATORYLEV1_OBJ_BANK,0,LABORATORYLEV1_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"lab 2 60",		LEVELID_LABORATORY2,LABORATORYLEV2_OBJ_BANK,0,LABORATORYLEV2_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"lab 3 80",		LEVELID_LABORATORY3,LABORATORYLEV3_OBJ_BANK,0,LABORATORYLEV3_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"lab boss a 70",LEVELID_LABORATORY4,LABORATORYBOSSA_OBJ_BANK,0,LABORATORYMASTERA_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
...
//------------------------------------------------ HALLOWEEN
	...
	5,						// number of levels 
		{ 
		"halloween 1 50",		LEVELID_HALLOWEEN1,	HALLOWEENLEV1_OBJ_BANK,0,HALLOWEENLEV1_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"halloween 2 50",		LEVELID_HALLOWEEN2,	HALLOWEENLEV2_OBJ_BANK,0,HALLOWEENLEV2_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"halloween boss 0",	LEVELID_HALLOWEEN4,	HALLOWEENBOSS_OBJ_BANK,0,HALLOWEENMASTER_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"halloween multi 20",	LEVELID_HALLOWEEN6,	HALLOWEENMULTI_OBJ_BANK,0,HALLOWEENMULTI_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		},
	},
...
//------------------------------------------------ SUPERRETRO
	...
	5,						// number of levels
		{ 
		"super 1 50",		LEVELID_SUPERRETRO1,RETROLEV1_OBJ_BANK,0,RETROLEV1_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 2 50",		LEVELID_SUPERRETRO2,RETROLEV2_OBJ_BANK,0,RETROLEV2_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 3 50",		LEVELID_SUPERRETRO3,RETROLEV3_OBJ_BANK,0,RETROLEV3_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 4 50",		LEVELID_SUPERRETRO4,RETROLEV4_OBJ_BANK,0,RETROLEV4_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 5 50",		LEVELID_SUPERRETRO5,RETROLEV5_OBJ_BANK,0,RETROLEV5_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 6 50",		LEVELID_SUPERRETRO6,RETROLEV6_OBJ_BANK,0,RETROLEV6_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 7 50",		LEVELID_SUPERRETRO7,RETROLEV7_OBJ_BANK,0,RETROLEV7_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 8 50",		LEVELID_SUPERRETRO8,RETROLEV8_OBJ_BANK,0,RETROLEV8_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 9 50",		LEVELID_SUPERRETRO9,RETROLEV9_OBJ_BANK,0,RETROLEV9_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"super 10 50",		LEVELID_SUPERRETRO10,RETROLEV10_OBJ_BANK,0,RETROLEV10_COL,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		},
	},
...
void InitLevel(unsigned long worldID,unsigned long levelID)
{
	...
	farClip = 	2500; //worldVisualData[worldID].levelVisualData[levelID].farDist;
