...
//------------------------------------------------ ANCIENT
	...
	7,						// number of levels
		...
		"ancient boss b",LEVELID_ANCIENTTRAPROOM1,BOSSB_ANCIENT_OBJ_BANK,BOSSB_ANCIENT_TEX_BANK,ANCIENTMASTERB_COL,GARDENLEV1_ENT,LEVEL_CLOSED,-1,0,
		"ancient boss c",LEVELID_ANCIENTTRAPROOM2,BOSSC_ANCIENT_OBJ_BANK,BOSSC_ANCIENT_TEX_BANK,ANCIENTMASTERC_COL,GARDENLEV1_ENT,LEVEL_CLOSED,-1,0,
