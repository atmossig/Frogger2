...
//------------------------------------------------ GARDEN
	...
	5,						// number of levels
		...
		"garden 2  60",	LEVELID_GARDEN2,GARDENLEV2_OBJ_BANK,0,GARDENLEV2_COL,LEVEL_OPEN,WORLDID_SPACE,0, 0,0,0,1100,1100,800,
		"garden 3  50",	LEVELID_GARDEN3,GARDENLEV3_OBJ_BANK,0,GARDENLEV3_COL,LEVEL_OPEN,WORLDID_CITY,0, 0,0, 0,1100,1100,800,
		"garden boss 10",	LEVELID_GARDEN4,GARDENBOSSA_OBJ_BANK,0,GARDENMASTERA_COL,LEVEL_OPEN,WORLDID_SUBTERRANEAN,0, 0,0, 0,1100,1100,800,
...
//------------------------------------------------ ANCIENT
	...
	5,						// number of levels
		{ 
		"ancient 1 40",	LEVELID_ANCIENT1,ANCIENTLEV1_OBJ_BANK,0,ANCIENTLEV1_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"ancient 2 40",	LEVELID_ANCIENT2,ANCIENTLEV2_OBJ_BANK,0,ANCIENTLEV2_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"ancient 3 30",	LEVELID_ANCIENT3,ANCIENTLEV3_OBJ_BANK,0,ANCIENTLEV3_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
...
//------------------------------------------------ CITY
	...
	5,						// number of levels
		{ 
		"city 1 30",		LEVELID_CITYDOCKS,CITYLEV1_OBJ_BANK,0,CITYLEV1_COL,LEVEL_OPEN,WORLDID_TOYSHOP,0, 0,0, 0,1100,1100,800,
...
//------------------------------------------------ SUBTERRANEAN
	...
	5,						// number of levels
		{ 
		"sub 1 40",		LEVELID_SUBTERRANEAN1,SUBTERRANEANLEV1_OBJ_BANK,0,SUBTERRANEANLEV1_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"sub 2 40",		LEVELID_SUBTERRANEAN2,SUBTERRANEANLEV2_OBJ_BANK,0,SUBTERRANEANLEV2_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"sub 3 20",		LEVELID_SUBTERRANEAN3,SUBTERRANEANLEV3_OBJ_BANK,0,SUBTERRANEANLEV3_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"sub boss 10",		LEVELID_SUBTERRANEAN4,SUBTERRANEANBOSS_OBJ_BANK,0,SUBTERRANEANMASTER_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"sub test xx",		LEVELID_SUBTERRANEAN4,SUBTERRANEANBOSSB_OBJ_BANK,0,SUBTERRANEANMASTERB_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"sub bonus 0",	LEVELID_SUBTERRANEAN5,SUBTERRANEANBONUS_OBJ_BANK,0,SUBTERRANEANBONUS_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"sub multi 0",	LEVELID_SUBTERRANEAN6,SUBTERRANEANMULTI_OBJ_BANK,0,SUBTERRANEANMULTI_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		},
	},
...
//------------------------------------------------ LABORATORY
	...
	5,						// number of levels
		{ 
		"lab 1 70",		LEVELID_LABORATORY1,LABORATORYLEV1_OBJ_BANK,0,LABORATORYLEV1_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
...
//------------------------------------------------ TOYSHOP
	...
	5,						// number of levels
		{ 
		"toy shop 1 0",		LEVELID_TOYSHOP1,TOYSHOPLEV1_OBJ_BANK,0,TOYSHOPLEV1_COL,LEVEL_OPEN,WORLDID_TOYSHOP,0, 0,0, 0,1100,1100,800,
...
//------------------------------------------------ HALLOWEEN
	...
	5,						// number of levels 
		{ 
		"halloween 1 10",		LEVELID_HALLOWEEN1,	HALLOWEENLEV1_OBJ_BANK,0,HALLOWEENLEV1_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"halloween 2 0",		LEVELID_HALLOWEEN2,	HALLOWEENLEV2_OBJ_BANK,0,HALLOWEENLEV2_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"halloween 3 0",		LEVELID_HALLOWEEN3,	HALLOWEENLEV3_OBJ_BANK,0,HALLOWEENLEV3_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"halloween boss 0",	LEVELID_HALLOWEEN4,	HALLOWEENBOSS_OBJ_BANK,0,HALLOWEENMASTER_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"halloween bonus 0",	LEVELID_HALLOWEEN5,	HALLOWEENBONUS_OBJ_BANK,0,-1,LEVEL_CLOSED,-1,0, 0,0, 0,1100,1100,800,
		"halloween multi 0",	LEVELID_HALLOWEEN6,	HALLOWEENMULTI_OBJ_BANK,0,HALLOWEENMULTI_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		},
	},
...
//------------------------------------------------ SUPERRETRO
	...
	5,						// number of levels
		{ 
		"super 1 60",		LEVELID_SUPERRETRO1,RETROLEV1_OBJ_BANK,0,RETROLEV1_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"super 2 60",		LEVELID_SUPERRETRO2,RETROLEV2_OBJ_BANK,0,RETROLEV2_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"super 3 60",		LEVELID_SUPERRETRO3,RETROLEV3_OBJ_BANK,0,RETROLEV3_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"super 4 60",		LEVELID_SUPERRETRO4,RETROLEV4_OBJ_BANK,0,RETROLEV4_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"super 5 60",		LEVELID_SUPERRETRO5,RETROLEV5_OBJ_BANK,0,RETROLEV5_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"super 6 60",		LEVELID_SUPERRETRO6,RETROLEV6_OBJ_BANK,0,RETROLEV6_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"super 7 60",		LEVELID_SUPERRETRO7,RETROLEV7_OBJ_BANK,0,RETROLEV7_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"super 8 60",		LEVELID_SUPERRETRO8,RETROLEV8_OBJ_BANK,0,RETROLEV8_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"super 9 60",		LEVELID_SUPERRETRO9,RETROLEV9_OBJ_BANK,0,RETROLEV9_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
		"super 10 60",		LEVELID_SUPERRETRO10,RETROLEV10_OBJ_BANK,0,RETROLEV10_COL,LEVEL_OPEN,-1,0, 0,0, 0,1100,1100,800,
